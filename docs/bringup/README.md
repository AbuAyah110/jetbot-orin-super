...
| G Model runtimes | [07-tensorrt.md](07-tensorrt.md) · G1 evidence: [07-tensorrt-g1.md](07-tensorrt-g1.md) · architecture audit: [../gemini_architecture_audit.md](../gemini_architecture_audit.md) | dummy I/O per runtime (isolated) |
